  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        Expanded(
          child: BlocConsumer<PerformerTaskListBloc, PerformerTaskListState>(
            listener: (context, state) {
              if (state is PerformerTaskListLoading) {
                if (state.index > -1) {
            ...
            builder: (context, state) {
              if (state is PerformerTaskListFailure) {
                return Center(
                        ...
                        return Column(
                          children: [
                            TaskCard(
                              ...
                              onTap: () {
                                context.pushNamed(
                                  AppRoutes.performerTaskDetail.name,
                                  extra: item,
                                );
                              },
